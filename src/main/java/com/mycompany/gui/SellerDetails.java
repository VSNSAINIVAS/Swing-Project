...
public class SellerDetails extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        stable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Seller ID", "Seller Name", "Phone", "Password", "Email"
            }
        ) {
    ...
    public void SelectSeller(){
        try{
            ...
            Rs = st.executeQuery("SELECT Seller_Seller_ID, Name, Phone, Password, E_Mail FROM user");
    ...
    private void AddbtnMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_AddbtnMouseClicked
        ...
        try{
            if(isValid(email.getText()) && isPassword(password.getText())){
                ...
                PreparedStatement toadd = con.prepareStatement("INSERT INTO seller VALUES(?)");
                toadd.setInt(1,Integer.valueOf(SelID.getText()));
                PreparedStatement toadd1 = con.prepareStatement("INSERT INTO user(Account_ID, E_Mail, Phone, Name, Password, Customer_Customer_ID,Seller_Seller_ID) VALUES (?, ?, ?, ?, ?, ?, ?)");
                ...
                toadd1.setInt(6,Integer.valueOf(SelID.getText()));
                toadd1.setInt(7,Integer.valueOf(SelID.getText()));
                toadd1.executeUpdate();
                int row = toadd.executeUpdate();
